...
public class VisionPotion 
{
	...
	{	if(dungeon == null) 
		throw new IllegalArgumentException("Dungeon Passed to vision potion is null");
		...
		{	if(row < 1) row = 1;
			for (int column = local [1]-1; column < local[1]+2 && column < dungeon.getDUNGEON_COLUMNS() - 1; column++)
